...
internal class Aufgabe21b : IAufgabe
{
    ...
    public string Calc()
    {
        PermuationGenerator<char> generator = new(['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h']);
        foreach (var permuation in generator.GetPermuations())
        {
            _password = [.. permuation];
            ...
            if (_password[0] == 'f' && _password[1] == 'b' && _password[2] == 'g' && _password[3] == 'd' &&
                _password[4] == 'c' && _password[5] == 'e' && _password[6] == 'a' && _password[7] == 'h')
            {
                return string.Join("", permuation);
            }
        }
